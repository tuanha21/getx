...
import '../../../get_core/get_core.dart' as core;
...
class SSSnackBar extends StatefulWidget {
  ...
  /// If not null, shows a bottom horizontal colored bar on notification.
  /// It is not possible to use it with a [Form] and I do not recommend
  /// using it with [LinearProgressIndicator]
  ...
  /// It is not possible to use it with a [Form] and I do not recommend
  /// using it with [LinearProgressIndicator]
  final double? bottomBarIndicatorHeight;
  ...
  const SSSnackBar({
    ...
    this.bottomBarIndicatorColor,
    this.bottomBarIndicatorHeight,
    this.boxShadows,
  ...
  @override
  State createState() => SSSnackBarState();
  ...
  SnackbarController show(BuildContext context) {
    return core.GetSnackBar.showSnackbar(context, this);
  }
}

class SSSnackBarState extends State<SSSnackBar> with TickerProviderStateMixin {
...
You need to either use message[String], or messageText[Widget] or define a userInputForm[Form] in GetSnackbar''');
  ...
  void _configureLeftBarFuture() {
    core.ambiguate(core.Engine.instance)!.addPostFrameCallback(
      (_) {
